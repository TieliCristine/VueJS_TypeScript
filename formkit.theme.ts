...
/**
  ...
  *
  * @checksum - beb04828ddab86c50c9a2a16723a6394fdd1e9b44092f85508993b9c2b937af8
  * @variables - radius=rounded-full,accentColor=blue,colorTemperature=gray,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=300,borderShadeDarkMode=700,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "color__inner": {
    ...
    "dark:group-data-[prefix-icon]:border-gray-700": true,
    "dark:group-data-[suffix-icon]:border-gray-700": true
  },
  "color__input": {
    "appearance-none": true,
    "[color-scheme:light]": true,
  ...
  "slider__minValue": {
    ...
    "dark:[&>div>div::after]:bg-gray-700": true
  },
  "slider__maxValue": {
    "grow": true,
    "!max-w-[45%]": true,
